let appi="https://newsapi.org/v2/top-headlines?country=in&category=technology&apiKey=6c052c42ae834af0a4edc5ca35d50bef";
...
fetch(appi).then(Response=>Response.json()).then(data=>{
        let obj=data;
