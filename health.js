let appii="https://newsapi.org/v2/top-headlines?country=in&category=health&apiKey=6c052c42ae834af0a4edc5ca35d50bef";
let heal=document.getElementById("health");
...
fetch(appii).then(Response=>Response.json()).then(data=>{
        let obj=data;
